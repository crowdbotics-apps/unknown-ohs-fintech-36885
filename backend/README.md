...
## Project Structure
    ...
    ├── unknown_ohs_fintech_36885  # Django project configurations
...
1. Clone this repo and `cd unknown_ohs_fintech_36885`
...
2. Clone this repo and `cd unknown_ohs_fintech_36885`
